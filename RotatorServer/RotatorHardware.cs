...
namespace ASCOM.Simulator
{
	...
	public static class RotatorHardware
	{
        ...
        private static string _rotatorName = "ASCOM.LoadSimulator.Rotator";
        private static string _description = "ASCOM Rotator Driver for Load Simulator";
        private static string _driverInfo = "ASCOM.LoadSimulator.Rotator";
        private static string _driverVersion = "6.4";
        private static short _interfaceVersion = 2;
        private static string s_sProgID = "ASCOM.LoadSimulator.Rotator";
